	...
	return (
		<main className="max-w-6xl mx-auto px-6 py-16">
			...
			<div className="grid md:grid-cols-3 gap-6 mt-12">
				{/* Card 1 */}
				<Link href="/library">
					<div className="bg-white rounded-lg shadow-md p-6 border-t-4 border-[#006837] hover:shadow-xl transition-shadow cursor-pointer">
						...
						<p className="text-gray-600">เข้าถึงเอกสารและความรู้ทางวิชาการได้ง่ายดาย ใครใจดีแบ่งด้วย</p>
					</div>
				</Link>

				{/* Card 2 */}
				<Link href="/finance">
					<div className="bg-white rounded-lg shadow-md p-6 border-t-4 border-[#FDB913] hover:shadow-xl transition-shadow cursor-pointer">
